...
| --- | --- | --- |
| Public repository and hosted quality | Complete | `main` is public. The last audited maintenance baseline is commit `8cbe7247b847d75f276b1d3057c76b9d69c0c9d8`: [CI run 32419502385](https://github.com/blisspixel/viewr/actions/runs/32419502385) passed all seven jobs and [fuzz run 32419502446](https://github.com/blisspixel/viewr/actions/runs/32419502446) passed both targets. The README badge and GitHub branch page are the live status. |
...
| Integrated product quality | Open for v0.6 | Matrix and candidate-artifact contract in [PRODUCT-QUALITY.md](PRODUCT-QUALITY.md). Next, integrate the versioned v0.6.0 candidate preparation and require green CI and fuzz. Then one new candidate workflow run, three complete representative-hardware records, downloaded archive hashes, verified run provenance, and a passing evidence gate remain. The successful v0.5.0 workflow rehearsal does not count as v0.6 evidence. |
