...
- [Install and update](INSTALL.md): current source builds, current v0.6.5
...
- [Sandbox plan](SANDBOX_PLAN.md): platform confinement profiles and limits.
- [Local intelligence policy](LOCAL-INTELLIGENCE.md): the gate for any optional,
  fully local model capability.
...
- [v0.6.5 release notes](releases/v0.6.5.md): the current shipped-feedback
  patch for page identity, substitution notices, and rating scope in the top
  status.
- [v0.6.4 release notes](releases/v0.6.4.md): the shipped-feedback
  patch for network storage, O(1) playlist indexing, and responsive culling.
- [v0.6.3 release notes](releases/v0.6.3.md): the shipped-feedback
  patch for remaining recovery copy and Image Information.
- [v0.6.2 release notes](releases/v0.6.2.md): the previous shipped-feedback
  patch for folder cull, collage Delete, and catalog-bound localization.
- [v0.6.1 release notes](releases/v0.6.1.md): the shipped-feedback
...
The project overview remains in [README.md](../README.md). These documents describe
the current implementation unless a section is explicitly labeled as proposed or
deferred.
