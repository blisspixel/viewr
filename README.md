...
v0.5.0 is the current public preview. Its portable archives are checksummed and
...
The published command downloads the v0.5.0 installer, which installs the v0.5.0
...
v0.5.0 is the current public preview and install target, not a percentage-complete
score or a claim that the product is finished. It is the closed format-contract
milestone after the published v0.4.0 file-coherence release.
The first preview v0.1.0, the v0.1.1 through v0.1.5 patches, v0.2.0, v0.3.0, and
