...
| --- | --- | --- |
| Public repository and hosted quality | Complete | `main` is public. The last audited maintenance baseline is commit `7408cd8a080029fb3852e744286f596224634dac`: [CI run 32438378680](https://github.com/blisspixel/viewr/actions/runs/32438378680) passed all seven jobs and [fuzz run 32438902890](https://github.com/blisspixel/viewr/actions/runs/32438902890) passed both targets. The README badge and GitHub branch page are the live status. |
