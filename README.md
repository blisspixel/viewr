...
v0.6.3 is the current public preview. Its portable archives are checksummed and
...
[v0.6.3 notes](docs/releases/v0.6.3.md) record that gap exactly.
...
The published command downloads the v0.6.3 installer, which installs the v0.6.3
...
The [current release notes](docs/releases/v0.6.3.md) state the exact published
