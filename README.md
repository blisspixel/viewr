...
v0.1.0 is the first public preview. Its portable archives are checksummed and
...
Both commands execute an installer fixed to the immutable v0.1.0 release. The
