...
v0.1.2 is the current public preview. Its portable archives are checksummed and
...
Both commands execute an installer fixed to the immutable v0.1.2 release. The
...
v0.1.2 is the current public foundation preview, not a percentage-complete score
or a claim that the product is finished. It is the second patch over the first
...
The [release notes](docs/releases/v0.1.2.md) state the exact preview limits.
