...
- [x] Publish and verify annotated tag `v0.6.1`, the shipped-feedback patch for
  rapid Trash curation, folder defaults, editing clarity, initial localization,
  and interface polish. Its release notes carry the same open representative-
  hardware evidence limit without claiming that automated gates replace it.
- [x] Publish and verify annotated tag `v0.6.2`, the shipped-feedback patch for
  folder-cull responsiveness, collage Delete, and catalog-bound localization.
  Published; see the GitHub release
...
- [x] Publish and verify annotated tag `v0.6.3`, the shipped-feedback patch for
  ...
  release notes carry the same open representative-hardware evidence limit
  and the remaining English fallback plus native-review gate.
- [x] Publish and verify annotated tag `v0.6.4`, the shipped-feedback patch for
  network storage and culling performance. Published; see the GitHub release
  [v0.6.4](https://github.com/blisspixel/viewr/releases/tag/v0.6.4). Its
  release notes carry the same open representative-hardware evidence limit
  and the remaining English fallback plus native-review gate.
...
1. **Public version:** the newest immutable published tag and its assets. It is
   currently v0.6.4. README and INSTALL call this the install target until a
...
2. **Workspace version:** the semantic version compiled into `viewr`, used in
   ...
   `0.6.4` while the carried v0.6 hardware gate remains open.
...
development commits. For v0.7.0, the update from `0.6.4` happens only after the
carried v0.6 product-quality matrix closes and before v0.7 accessibility evidence
begins.

The v0.6.1, v0.6.2, v0.6.3, and v0.6.4 patches were narrow exceptions for confirmed shipped
...
```text
gh release view v0.6.1 --repo blisspixel/viewr
gh release verify v0.6.1 --repo blisspixel/viewr
gh attestation verify viewr-0.6.1-x86_64-pc-windows-msvc.zip \
...
For v0.6.2, [main CI run 34350425828](https://github.com/blisspixel/viewr/actions/runs/34350425828)
passed all seven jobs, [fuzz run 34350425680](https://github.com/blisspixel/viewr/actions/runs/34350425680)
passed both targets, and [CodeQL run 34350426613](https://github.com/blisspixel/viewr/actions/runs/34350426613)
passed on commit `d3e036d19c61179bafb8727b0834faf9d6220b4c`.
[Release run 34351452038](https://github.com/blisspixel/viewr/actions/runs/34351452038)
then repeated all nine prerequisite jobs, built all four platform archives, and
published the immutable 12-asset [v0.6.2 release](https://github.com/blisspixel/viewr/releases/tag/v0.6.2).
The official Windows archive has SHA-256
`3a76f0286f99ca119f417ea9937d0a121a159bf69c416877c1adbdbd4f6020fc` and
...
- v0.6.4 is public, immutable, checksummed, and attested, and v0.6.3, v0.6.2, v0.6.1, v0.6.0, v0.5.0, v0.4.0, v0.3.0, v0.2.0, v0.1.5, v0.1.4,
  v0.1.3, v0.1.2, v0.1.1, and v0.1.0 remain published, the first preview with a
  known-issues note. v0.6.4, v0.6.3, v0.6.2, v0.6.1, and v0.6.0 carry no representative-hardware
