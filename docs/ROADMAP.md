...
| --- | --- | --- |
| Public repository and hosted quality | Complete | `main` is public and protected. The README badge and GitHub branch page are the live status. Commit `fdfc94b5c86fcfdfeed1242c859fb65a4b0f1376` passed [CI run 32589505330](https://github.com/blisspixel/viewr/actions/runs/32589505330), [CodeQL run 32589504977](https://github.com/blisspixel/viewr/actions/runs/32589504977), exact-head [fuzz run 32589521673](https://github.com/blisspixel/viewr/actions/runs/32589521673), and non-publishing [candidate run 32589977007](https://github.com/blisspixel/viewr/actions/runs/32589977007). |
