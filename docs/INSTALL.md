...
```powershell
irm https://github.com/blisspixel/viewr/releases/download/v0.2.0/install.ps1 | iex
```
...
```powershell
irm https://github.com/blisspixel/viewr/releases/download/v0.2.0/install.ps1 `
  -OutFile $env:TEMP\viewr-install.ps1
& $env:TEMP\viewr-install.ps1 -Version 0.2.0
```
...
```sh
curl -fsSL https://github.com/blisspixel/viewr/releases/download/v0.2.0/install.sh | sh
```
...
above are fixed to the immutable `v0.2.0` release rather than a moving branch.
To review it first:

```sh
curl -fsSLO https://github.com/blisspixel/viewr/releases/download/v0.2.0/install.sh
less install.sh
sh install.sh
```
...
GitHub checksums and attestations improve integrity and provenance. The v0.2.0
