...
class ReleaseArtifactTests(unittest.TestCase):
    ...
    def test_public_and_compiled_installers_use_immutable_release_assets(
        ...
        self.assertIn("/releases/download/v0.6.4/install.ps1", public_commands)
        self.assertIn("/releases/download/v0.6.4/install.sh", public_commands)
        self.assertIn("/releases/download/v0.6.4/install.ps1", compiled_commands)
        self.assertIn("/releases/download/v0.6.4/install.sh", compiled_commands)
