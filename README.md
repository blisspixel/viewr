...
v0.1.1 is the current public preview. Its portable archives are checksummed and
...
Both commands execute an installer fixed to the immutable v0.1.1 release. The
...
v0.1.1 is the current public foundation preview, not a percentage-complete score
or a claim that the product is finished. It is a patch release over the first
...
The [release notes](docs/releases/v0.1.1.md) state the exact preview limits.
