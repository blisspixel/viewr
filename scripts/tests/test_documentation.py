...
class DocumentationTests(unittest.TestCase):
    ...
    def test_public_release_state_is_consistent(self) -> None:
        requirements = {
            ".github/ISSUE_TEMPLATE/bug_report.yml": ("0.6.3 or commit SHA",),
            "README.md": (
                "v0.6.3 is the current public preview",
                "checksummed and",
                "attested",
            ...
            "docs/INSTALL.md": (
                "v0.6.3 is the current public GitHub Release",
                "checksummed",
                "manifest-verified",
                "attested",
                "not Authenticode-signed",
            ...
            "docs/ROADMAP.md": (
                "Published install target | Immutable [v0.6.3]",
            ...
            "docs/PUBLISHING.md": (
                "v0.6.3 is public, immutable, checksummed, and attested",
