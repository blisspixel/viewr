...
Commit `4530ce3` passed exact-head CI, CodeQL, and fuzz, followed by one successful
...
| --- | --- | --- |
| Public repository and hosted quality | Complete | `main` is public and protected. The README badge and GitHub branch page are the live status. Commit `4530ce354f220aa9f6d9a0cb0d7bba50ad15311b` passed [CI run 32600643062](https://github.com/blisspixel/viewr/actions/runs/32600643062), [CodeQL run 32600642952](https://github.com/blisspixel/viewr/actions/runs/32600642952), exact-head [fuzz run 32600643070](https://github.com/blisspixel/viewr/actions/runs/32600643070), and non-publishing [candidate run 32601112068](https://github.com/blisspixel/viewr/actions/runs/32601112068). |
...
| Integrated product quality | Open for v0.6 | Matrix and candidate-artifact contract in [PRODUCT-QUALITY.md](PRODUCT-QUALITY.md). Exact-head [candidate run 32601112068](https://github.com/blisspixel/viewr/actions/runs/32601112068) retains four verified platform archives plus the deterministic fixture artifact from `4530ce3`. Next, collect the three representative-hardware records and eight-session performance report set against only those bytes. v0.5.0 remains the public install target until that evidence passes. |
...
- [ ] Exercise first-time, fast-path, admin, failure-recovery, keyboard-only, and
  ...
  [candidate run 32601112068](https://github.com/blisspixel/viewr/actions/runs/32601112068)
  from `4530ce3` retains the four verified platform archives and deterministic
