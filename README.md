...
v0.6.2 is the current public preview. Its portable archives are checksummed and
...
[v0.6.2 notes](docs/releases/v0.6.2.md) record that gap exactly.
...
The published command downloads the v0.6.2 installer, which installs the v0.6.2
...
v0.6.2 is the current public preview and install target, not a percentage-complete
score or a claim that the product is finished. It is the shipped-feedback patch
over v0.6.1 and the integrated v0.6.0 product-quality beta.
The first preview v0.1.0, the v0.1.1 through v0.1.5 patches, v0.2.0, v0.3.0,
v0.4.0, v0.5.0, and v0.6.1 remain published. `main` continues the logical order in the
...
The [current release notes](docs/releases/v0.6.2.md) state the exact published
