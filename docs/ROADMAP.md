...
| Item | State |
| --- | --- |
| Published install target | Immutable [v0.1.2](https://github.com/blisspixel/viewr/releases/tag/v0.1.2), the second patch over [v0.1.0](https://github.com/blisspixel/viewr/releases/tag/v0.1.0) |
...
Current position: v0.1.2 is released and verified, and v0.1.1 and v0.1.0 remain
