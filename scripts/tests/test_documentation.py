...
class DocumentationTests(unittest.TestCase):
    ...
    def test_public_release_state_is_consistent(self) -> None:
        requirements = {
            "README.md": (
                "v0.1.2 is the current public preview",
                "checksummed and",
                "attested",
            ...
            "docs/INSTALL.md": (
                "v0.1.2 is the current public GitHub Release",
                "checksummed",
                "manifest-verified",
                "attested",
                "not Authenticode-signed",
            ...
            "docs/ROADMAP.md": (
                "Current position: v0.1.2 is released and verified",
            ...
            "docs/PUBLISHING.md": (
                "v0.1.2 is public, immutable, checksummed, and attested",
