...
class DocumentationTests(unittest.TestCase):
    ...
    def test_public_release_state_is_consistent(self) -> None:
        requirements = {
            "README.md": (
                "v0.2.0 is the current public preview",
                "checksummed and",
                "attested",
            ...
            "docs/INSTALL.md": (
                "v0.2.0 is the current public GitHub Release",
                "checksummed",
                "manifest-verified",
                "attested",
                "not Authenticode-signed",
            ...
            "docs/ROADMAP.md": (
                "Current position: v0.2.0 is released and verified",
            ...
            "docs/PUBLISHING.md": (
                "v0.2.0 is public, immutable, checksummed, and attested",
    ...
    def test_pre_one_version_path_builds_product_before_distribution(self) -> None:
        ...
        self.assertIn("Immediate focus: v0.3 display correctness", roadmap)
