...
v0.1.5 is the current public preview. Its portable archives are checksummed and
...
Both commands execute an installer fixed to the immutable v0.1.5 release. The
...
v0.1.5 is the current public foundation preview, not a percentage-complete score
...
The [release notes](docs/releases/v0.1.5.md) state the exact preview limits.
